...
class Page_model extends CI_Model{
    ...
    var $table = 'posts';
    var $column_order = array(null, 'Title','Category', 'Author', 'Date');
    var $column_search = array('Title','Category','Author','Date');
    var $order = array('posts' => 'asc');
    ...
    public function submit_form_data($data)
    {
        ...
        {
            $data['prod_update'] = date('Y-m-d h:i:s');
            $this->db->set($data);
        ...
        {
            unset($data['prod_id']);
            $data['prod_create'] = date('Y-m-d h:i:s');
            $this->db->set($data);
