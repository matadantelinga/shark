			...
			<div class="office-info-container content-padding">
				<div class="row">
					...
					<div class="col-md-4 col-sm-4">
						<h3>Head Office</h3>
						<ul>
							<li style="background:url(<?php asset_url('shark'); ?>images/icon-mail-orange.png) left center no-repeat; padding-left:25px;"><a href="#">mail@shark.co.id</a></li>
							<li style="background: url(<?php asset_url('shark'); ?>images/icon-phone-orange.png) left center no-repeat; padding-left:25px;"><a href="#">+6221 5903411</a></li>
							<li style="background: url(<?php asset_url('shark'); ?>images/icon-location.png) left center no-repeat; padding-left:25px;"><a href="#">Alam Sutera, Tangerang Selatan</a></li>
						</ul>
					</div>
					<div class="col-md-4 col-sm-4">
						...
						<ul>
							<li style="background:url(<?php asset_url('shark'); ?>images/icon-mail-orange.png) left center no-repeat; padding-left:25px;"><a href="#">mail@shark.co.id</a></li>
							<li style="background: url(<?php asset_url('shark'); ?>images/icon-phone-orange.png) left center no-repeat; padding-left:25px;"><a href="#">+6221 5903411</a></li>
							<li style="background: url(<?php asset_url('shark'); ?>images/icon-location.png) left center no-repeat; padding-left:25px;"><a href="#">Jl. Industri Keroncong No. 06<br/>
								Jatiuwung, Tangerang</a></li>
						</ul>
					</div>
				</div>
			</div>
